...
- Planilhas de triagem (Fase 1 – títulos, Fase 2 – resumos, Fase 3 – texto completo).
- Formulário de extração de dados padronizado.
- Classificação dos estudos incluídos conforme técnicas de IA, tipo de adaptação e métricas.
- Códigos ou scripts auxiliares, quando utilizados.
...
- Triagem em múltiplas fases com critérios explícitos de inclusão/exclusão.
- Extração de dados usando template padronizado.
